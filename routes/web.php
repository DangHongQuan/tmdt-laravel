...
Route::get('/admin','App\Http\Controllers\Admin\AdminController@showLoginForm')->name('layouts.login');
...
Route::get('/admin/login','App\Http\Controllers\Admin\AdminController@dangxuat')->name('login');

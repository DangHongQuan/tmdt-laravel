...
<head>
  ...
  <title>Shopee Việt Nam | Mua và Bán trên ứng dụng điện thoại hoặc Website</title>
</head>
...
<body>
    ...
    <div class="container">
      ...
      <div class="d-flex align-items-center mt-4">
        <div class="d-flex align-items-center">
          ...
          <span class="text-brand"><a href="{{URL::TO('/trang-chu')}}"class="text-brand text-decoration-none text-white">Shopee</a></span>
        </div>
        <div class="wrap-navbar-input">
          <div class="wrap-search">
            <input type="text" class="form-control" placeholder="Nhanh tay săn voucher lên đến 50%" />
            <div class="wrap-icon-s">
              <img class="icon-media" src="{{asset('frontend/assets/search.png')}}" alt="" />
            </div>
          </div>
        ...
        <div class="header__cart">
          <div class="header__cart-wrap">
            ...
            <div class="header__cart-list ">
              <!-- Nocart -->
              <img src="{{asset('frontend/assets/no-cart.png')}}" alt="No Cart" class="header__cart-no-cart-img" />
              ...
              <ul class="header__cart-list-item">
                <li class="header__cart-item">
                  <img src="https://placeimg.com/320/120/tech" alt="" class="header__cart-img" />
  ...
  <div class="content">
    ...
    <img class="shape1" src="{{asset('frontend/assets/shape1.png')}}" alt="" />
    <img class="shape2" src="{{asset('frontend/assets/shape2.png')}}" alt="" />
    <img class="shape3" src="{{asset('frontend/assets/shape1.png')}}" alt="" />
    <img class="shape4" src="{{asset('frontend/assets/shape2.png')}}" alt="" />
